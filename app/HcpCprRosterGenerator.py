...
def generate_course_info_page_pdf(course_info, num_students):
    ...
    # renewal
    can.drawString(58, 415, u"✗")


    can.drawString(495, 426, course_info['instructor_name'])
    can.drawString(512, 403, course_info['instructor_renewal_date'])
    can.drawString(493, 389, course_info['training_center_name'])
    can.drawString(510, 378, course_info['training_center_id'])
    can.drawString(493, 355, course_info['course_location'])

    can.drawString(165, 283, course_info['course_date'])
    can.drawString(378, 283, course_info['course_date'])
    can.drawString(614, 283, "4")
    can.drawString(153, 260, str(num_students))
    can.drawString(381, 260, course_info['student_manikin_ratio'])
    can.drawString(581, 260, course_info['card_issue_date'])
    ...
    #cards
    roster_filename = os.path.join(dir, 'templates','HCP_roster.pdf')
...
def generate_student_page_pdf(students, instructor_name, course_date):
    ...
    can.drawString(238, 571, "BLS HCP")
